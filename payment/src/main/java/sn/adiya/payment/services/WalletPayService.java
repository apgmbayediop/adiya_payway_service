...
import sn.fig.common.config.entities.ToolsPartner;
...
import sn.adiya.partner.orangemoney.dto.OMAmountDto;
import sn.adiya.partner.orangemoney.dto.OMClientDto;
import sn.adiya.partner.orangemoney.dto.OMPayResponse;
import sn.adiya.partner.orangemoney.dto.OMPaymentDto;
...
import sn.adiya.payment.dto.ReloadWalletDto;
import sn.adiya.payment.dto.ReloadWalletResponse;
...
import sn.adiya.wave.dto.WaveRequest;
import sn.adiya.wave.services.WaveService;
...
public class WalletPayService {
	...
	@Inject
	private AdiyaCommonTools tools;
	@Inject
	...
	public void initWave() {
		try {
			...
			if (Constantes.PREPROD_ENV.equals(tools.getProperty(Constantes.ENV_PRPOPERTY))) {
				baseHookUrl = "https://preadiya.afriadiya.com";
			} else if (Constantes.PROD_ENV.equals(tools.getProperty(Constantes.ENV_PRPOPERTY))) {
				baseHookUrl = "https://adiya.afriadiya.com";
			}  
			else {
				baseHookUrl = "https://wdev.afriadiya.com";
			}
	...
	public PaymentDetails directPayment(Caisse caisse, PaymentDto dto) throws AdiyaException {
		PaymentDetails resp = new PaymentDetails();
	...
	public PaymentDetails sendPayment(String bank, PaymentDto dto, Caisse caisse) throws AdiyaException {
		...
		default:
			throw new AdiyaException(ErrorResponse.UNKNOWN_ERROR.getCode(),
	...
	public PaymentDetails wavePayment(PaymentDto dto, Caisse caisse) {
		...
		try {
			...
			if (commingReturUrl.contains("intero.afriadiya.com")) {
	...
	public String getBankWallet(String bank) throws AdiyaException {
		String codeBank;
