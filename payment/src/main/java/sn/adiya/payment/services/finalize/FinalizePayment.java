package sn.adiya.payment.services.finalize;
...
import sn.fig.account.entities.PartnerAccount;
import sn.fig.commission.entities.PayerCommission;
import sn.fig.commission.entities.SenderCommission;
...
import sn.fig.common.utils.AccountManager;
import sn.fig.common.utils.AccountManagerBean;
...
import sn.fig.entities.EventBookedTicket;
import sn.fig.entities.EventTicket;
import sn.fig.entities.LinkedCard;
import sn.fig.entities.OptimaFavorites;
...
import sn.adiya.payment.dto.DispatchPayCommission;
...
import sn.adiya.payment.sd.SDManager;
import sn.adiya.payment.services.GatewayApiController;
import sn.adiya.payment.services.OnlinePaymentService;
import sn.adiya.payment.sms.SMSSender;
import sn.adiya.payment.tokenization.CardTokenization;
...
public class FinalizePayment {
	...
	public static final String adiya_CODE_BANK = "adiya";
	...
	public PaymentDetails updateTransaction(String statusCode, PaymentDto request, IsoAcquisition acquisition,
		...
		try {
			...
			if (!adiya_CODE_BANK.equals(codeBank)) {
