...
@Stateless
public class FinaoGimControllerOperation {

	private static final Logger LOG = Logger.getLogger(FinaoGimControllerOperation.class);
	...
	@PostConstruct
	public void init() {
		LOG.info("init finao gim controller operation");
