package sn.payway.card.generation;
...
import sn.apiapg.entities.CardGenerationLot;
...
import sn.payway.card.generation.dto.CardGenerationDto;
...
public static final Logger LOG = Logger.getLogger(CardGenService.class);
	...
	public static final String KEY = "PAYWAYMON";
